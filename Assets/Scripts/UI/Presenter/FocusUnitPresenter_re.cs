...
{
    public class FocusUnitPresenter_re : IDisposable
    {
        ...
        public FocusUnitPresenter_re(FocusUnitView view)
        {
            _view = view;
            _presentDisposables = new();

            Observable.FromEvent<IUnitCore>(
                h => FocusUnitService.OnFocusChanged += h,
                h => FocusUnitService.OnFocusChanged -= h)
                .Subscribe(BindUnit)
        ...
        private void BindUnit(IUnitCore unit)
        {
            ...
            _vitalityFeature?.Vitality._onPercentageChangedSubject
            ...
            _mentalFeature?.Mental._onPercentageChangedSubject
